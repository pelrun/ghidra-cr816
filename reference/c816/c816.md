...
(define_peephole2
  [(set (match_operand:HI 0 "general_operand" "=g")
        (match_operand:HI 1 "general_operand" "g"))
   (set (match_operand:HI 2 "general_operand" "=g")
...
;; movtqf
(define_insn "movtqf"
  [(set (match_operand:TQF 0 "general_operand" "=g")
   (match_operand:TQF 1 "general_operand" "g"))]
  ""
  "*
{
  return output_move(insn, operands);
...
;; addtqf3
;;
;; CI - fixme - GCC fails to optimize some double moves (i.e., MOVE
;; a,b; MOVE b,a where b is dead after the second move, seen for
;; example in bench.c).  It would probably be a good idea to do some
;; scan of the instructions to detect and remove those useless moves.
;; The scan could perhaps be done when the life span of registers is
;; known.
(define_expand "addtqf3"
  [(parallel [(set (reg:TQF 1)
         (plus:TQF (match_operand:TQF 1 "general_operand" "")
              (match_operand:TQF 2 "general_operand" "")))
         (clobber (reg:QI 4))])
    ...
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          ...
          gen_rtx(SET, VOIDmode,
             gen_rtx(REG, TQFmode, REG_0),
             gen_rtx(PLUS, TQFmode,
...
(define_insn "*addtqf3"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (plus:TQF (match_operand:TQF 1 "general_operand" "g")
        (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_libcall(insn, operands, 1, 1, 1, \"addtqf3\", 0, 0, 0);
}"
  [(set_attr "type" "lib")])

(define_insn "*addtqf3_s"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (plus:TQF (match_operand:TQF 1 "general_operand" "g")
        (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))
...
;; subtqf3
(define_expand "subtqf3"
  [(parallel [(set (reg:TQF 1)
         (minus:TQF (match_operand:TQF 1 "general_operand" "")
               (match_operand:TQF 2 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
...
(define_insn "*subtqf3"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (minus:TQF (match_operand:TQF 1 "general_operand" "g")
         (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_libcall(insn, operands, 1, 1, 0, \"addtqf3\", 1, 0, 0);
}"
  [(set_attr "type" "lib")])

(define_insn "*subtqf3_s"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (minus:TQF (match_operand:TQF 1 "general_operand" "g")
         (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))
...
(define_insn "negtqf2"
  [(set (match_operand:TQF 0 "general_operand" "=g")
   (neg:TQF (match_operand:TQF 1 "general_operand" "g")))]
  ""
  "*
{
...
;; multqf3
(define_expand "multqf3"
  [(parallel [(set (reg:TQF 1)
         (mult:TQF (match_operand:TQF 1 "general_operand" "")
              (match_operand:TQF 2 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
...
(define_insn "*multqf3"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (mult:TQF (match_operand:TQF 1 "general_operand" "g")
        (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_libcall(insn, operands, 1, 1, 1, \"multqf3\", 0, 0, 0);
}"
  [(set_attr "type" "lib")])

(define_insn "*multqf3_s"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (mult:TQF (match_operand:TQF 1 "general_operand" "g")
        (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))
...
;; divtqf3
(define_expand "divtqf3"
  [(parallel [(set (reg:TQF 1)
         (div:TQF (match_operand:TQF 1 "general_operand" "")
             (match_operand:TQF 2 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
...
(define_insn "*divtqf3"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (div:TQF (match_operand:TQF 1 "general_operand" "g")
       (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_libcall(insn, operands, 1, 1, 0, \"divtqf3\", 0, 0, 0);
}"
  [(set_attr "type" "lib")])

(define_insn "*divtqf3_s"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (div:TQF (match_operand:TQF 1 "general_operand" "g")
       (match_operand:TQF 2 "general_operand" "g")))
   (clobber (reg:QI 4))
...
(define_insn "tsttqf"
  [(set (cc0)
   (match_operand:TQF 0 "general_operand" "g"))]
  ""
  "")

(define_expand "cmptqf"
  [(parallel [(set (cc0)
         (compare (match_operand:TQF 0 "general_operand" "g")
             (match_operand:TQF 1 "general_operand" "g")))
         (set (reg:TQF 1) (mem:TQF (const_int 0)))])]
  ""
  "
{
  if (TARGET_SOFTLIB
      && nonimmediate_operand(operands[0], TQFmode)
      && nonimmediate_operand(operands[1], TQFmode)) {
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          gen_rtvec(3,
          gen_rtx(SET, VOIDmode,
...
;; integer to TQF
; QI
(define_expand "floatunsqitqf2"
  [(parallel [(set (reg:TQF 1)
         (unsigned_float:TQF (match_operand:QI 1 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
  ""
  ...
  if (TARGET_SOFTLIB) {
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          ...
          gen_rtx(SET, VOIDmode,
             gen_rtx(REG, TQFmode, REG_0),
             gen_rtx(UNSIGNED_FLOAT, TQFmode, operands[1])),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, QImode, REG_3)),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, Pmode, ROM_IDX)))));
...
(define_insn "*floatunsqitqf2"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (unsigned_float:TQF (match_operand:QI 1 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
...
; HI
(define_expand "floathitqf2"
  [(parallel [(set (reg:TQF 1)
         (float:TQF (match_operand:HI 1 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
  ""
  ...
  if (TARGET_SOFTLIB) {
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          ...
          gen_rtx(SET, VOIDmode,
             gen_rtx(REG, TQFmode, REG_0),
             gen_rtx(FLOAT, TQFmode, operands[1])),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, QImode, REG_3)),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, Pmode, ROM_IDX)))));
...
(define_expand "floatunshitqf2"
  [(parallel [(set (reg:TQF 1)
         (unsigned_float:TQF (match_operand:HI 1 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
  ""
...
(define_insn "*floatunsqitqf2_ext"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (float:TQF (zero_extend:HI
          (match_operand:QI 1 "general_operand" "g"))))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
...
(define_insn "*floatunsqitqf2_ext_s"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (float:TQF (zero_extend:HI
          (match_operand:QI 1 "general_operand" "g"))))
   (clobber (reg:QI 4))
...
(define_insn "*floatqitqf2_ext"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (float:TQF (sign_extend:HI
          (match_operand:QI 1 "general_operand" "g"))))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
...
(define_insn "*floathitqf2"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (float:TQF (match_operand:HI 1 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_insn "*floatunshitqf2"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (unsigned_float:TQF (match_operand:HI 1 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_expand "floatsitqf2"
  [(parallel [(set (reg:TQF 1)
         (float:TQF (match_operand:SI 1 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
  ""
...
(define_expand "floatunssitqf2"
  [(parallel [(set (reg:TQF 1)
         (unsigned_float:TQF (match_operand:SI 1 "general_operand" "")))
         (clobber (reg:QI 4))])
   (set (match_operand:TQF 0 "general_operand" "")
   (reg:TQF 1))]
  ""
...
(define_insn "*floatsitqf2"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (float:TQF (match_operand:SI 1 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_insn "*floatunssitqf2"
  [(set (match_operand:TQF 0 "data_reg_operand" "=c")
   (unsigned_float:TQF (match_operand:SI 1 "general_operand" "g")))
   (clobber (reg:QI 4))]
  "!TARGET_SOFTLIB"
  "*
{
...
;; -----------------------------------------------------------------
;; Conversion from float to integer instructions.
;; -----------------------------------------------------------------

; TQF to integer
(define_expand "fix_trunctqfqi2"
  [(parallel [(set (reg:QI 4)
         (fix:QI (match_operand:TQF 1 "general_operand" "")))
         (clobber (reg:QI 1))
         (clobber (reg:QI 2))
         (clobber (reg:QI 3))])
   (set (match_operand:QI 0 "general_operand" "")
...
(define_insn "*fix_trunctqfqi2"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (fix:QI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
   (clobber (reg:QI 3))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_to_int(insn, operands, 0);
}"
  [(set_attr "type" "lib")])

(define_insn "*fix_trunctqfqi2_s"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (fix:QI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
...
(define_expand "fixuns_trunctqfqi2"
  [(parallel [(set (reg:QI 4)
         (unsigned_fix:QI (match_operand:TQF 1 "general_operand" "")))
         (clobber (reg:QI 1))
         (clobber (reg:QI 2))
         (clobber (reg:QI 3))])
   (set (match_operand:QI 0 "general_operand" "")
  ...
  if (TARGET_SOFTLIB) {
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          ...
          gen_rtx(SET, VOIDmode,
             gen_rtx(REG, QImode, REG_3),
             gen_rtx(UNSIGNED_FIX, QImode, operands[1])),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, QImode, REG_0)),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, QImode, REG_1)),
...
(define_insn "*fixuns_trunctqfqi2"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (unsigned_fix:QI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
   (clobber (reg:QI 3))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_to_int(insn, operands, 1);
}"
  [(set_attr "type" "lib")])

(define_insn "*fixuns_trunctqfqi2_s"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (unsigned_fix:QI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
...
(define_expand "fix_trunctqfhi2"
  [(parallel [(set (reg:HI 3)
         (fix:HI (match_operand:TQF 1 "general_operand" "")))
         (clobber (reg:HI 1))])
   (set (match_operand:HI 0 "general_operand" "")
   (reg:HI 3))]
  ""
...
(define_insn "*fix_trunctqfhi2"
  [(set (match_operand:HI 0 "data_reg2_operand" "=e")
   (fix:HI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:HI 1))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_expand "fixuns_trunctqfhi2"
  [(parallel [(set (reg:HI 3)
         (unsigned_fix:HI (match_operand:TQF 1 "general_operand" "")))
         (clobber (reg:HI 1))])
   (set (match_operand:HI 0 "general_operand" "")
   (reg:HI 3))]
  ""
  ...
  if (TARGET_SOFTLIB) {
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          ...
          gen_rtx(SET, VOIDmode,
             gen_rtx(REG, HImode, REG_2),
             gen_rtx(UNSIGNED_FIX, HImode, operands[1])),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, HImode, REG_0)),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, Pmode, ROM_IDX)))));
...
(define_insn "*fixuns_trunctqfhi2"
  [(set (match_operand:HI 0 "data_reg2_operand" "=e")
   (unsigned_fix:HI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:HI 1))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_insn "*fixuns_trunctqfhi2_s"
  [(set (match_operand:HI 0 "data_reg2_operand" "=e")
   (unsigned_fix:HI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:HI 1))
   (clobber (reg:HI 5))]
...
(define_expand "fix_trunctqfsi2"
  [(set (reg:SI 1)
   (fix:SI (match_operand:TQF 1 "general_operand" "")))
   (set (match_operand:SI 0 "general_operand" "")
   (reg:SI 1))]
  ""
  "
...
(define_insn "*fix_trunctqfsi2"
  [(set (match_operand:SI 0 "data_reg_operand" "=f")
   (fix:SI (match_operand:TQF 1 "general_operand" "g")))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_to_int(insn, operands, 0);
...
(define_expand "fixuns_trunctqfsi2"
  [(set (reg:SI 1)
   (unsigned_fix:SI (match_operand:TQF 1 "general_operand" "")))
   (set (match_operand:SI 0 "general_operand" "")
   (reg:SI 1))]
  ""
  "
  ...
  if (TARGET_SOFTLIB) {
    emit_insn(gen_rtx
         (PARALLEL, VOIDmode,
          ...
          gen_rtx(SET, VOIDmode,
             gen_rtx(REG, SImode, REG_0),
             gen_rtx(UNSIGNED_FIX, SImode, operands[1])),
          gen_rtx(CLOBBER, VOIDmode,
             gen_rtx(REG, Pmode, ROM_IDX)))));
    emit_insn(gen_rtx(SET, VOIDmode, operands[0],
            gen_rtx(REG, SImode, REG_0)));
...
(define_insn "*fixuns_trunctqfsi2"
  [(set (match_operand:SI 0 "data_reg_operand" "=f")
   (unsigned_fix:SI (match_operand:TQF 1 "general_operand" "g")))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_to_int(insn, operands, 1);
...
(define_insn "*fixuns_trunctqfsi2_s"
  [(set (match_operand:SI 0 "data_reg_operand" "=f")
   (unsigned_fix:SI (match_operand:TQF 1 "general_operand" "g")))
   (clobber (reg:HI 5))]
  "TARGET_SOFTLIB"
...
(define_insn "*fix_truncsfqi2"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (fix:QI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
   (clobber (reg:QI 3))]
  "!TARGET_SOFTLIB"
...
(define_expand "fixuns_truncsfqi2"
  [(parallel [(set (reg:QI 4)
         (unsigned_fix:QI (match_operand:SF 1 "general_operand" "")))
         (clobber (reg:QI 1))
         (clobber (reg:QI 2))
         (clobber (reg:QI 3))])
   (set (match_operand:QI 0 "general_operand" "")
...
(define_insn "*fixuns_truncsfqi2"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (unsigned_fix:QI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
   (clobber (reg:QI 3))]
  "!TARGET_SOFTLIB"
...
(define_insn "*fixuns_truncsfqi2_s"
  [(set (match_operand:QI 0 "data_reg3_operand" "=y")
   (unsigned_fix:QI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:QI 1))
   (clobber (reg:QI 2))
...
(define_insn "*fix_truncsfhi2"
  [(set (match_operand:HI 0 "data_reg2_operand" "=e")
   (fix:HI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:HI 1))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_insn "*fixuns_truncsfhi2"
  [(set (match_operand:HI 0 "data_reg2_operand" "=e")
   (unsigned_fix:HI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:HI 1))]
  "!TARGET_SOFTLIB"
  "*
{
...
(define_insn "*fixuns_truncsfhi2_s"
  [(set (match_operand:HI 0 "data_reg2_operand" "=e")
   (unsigned_fix:HI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:HI 1))
   (clobber (reg:HI 5))]
...
(define_insn "*fix_truncsfsi2"
  [(set (match_operand:SI 0 "data_reg_operand" "=f")
   (fix:SI (match_operand:SF 1 "general_operand" "g")))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_to_int(insn, operands, 0);
...
(define_insn "*fixuns_truncsfsi2"
  [(set (match_operand:SI 0 "data_reg_operand" "=f")
   (unsigned_fix:SI (match_operand:SF 1 "general_operand" "g")))]
  "!TARGET_SOFTLIB"
  "*
{
  return output_to_int(insn, operands, 1);
...
(define_insn "*fixuns_truncsfsi2_s"
  [(set (match_operand:SI 0 "data_reg_operand" "=f")
   (unsigned_fix:SI (match_operand:SF 1 "general_operand" "g")))
   (clobber (reg:HI 5))]
  "TARGET_SOFTLIB"
...
;; -----------------------------------------------------------------
;; Floating point truncation instructions.
;;
;; Have to modify function convert_move in expr.c to make it recognize
;; conversions to and from mode TQF.
;; -----------------------------------------------------------------

;; truncsftqf2
(define_insn "truncsftqf2"
  [(set (match_operand:TQF 0 "general_operand" "=g")
   (float_truncate:TQF (match_operand:SF 1 "general_operand" "g")))]
  ""
  "*
{
  return output_move(insn, operands);
...
;; -----------------------------------------------------------------
;; Floating point extend instructions.
;; -----------------------------------------------------------------

;; extendtqfsf2
(define_insn "extendtqfsf2"
  [(set (match_operand:SF 0 "general_operand" "=g")
   (float_extend:SF (match_operand:TQF 1 "general_operand" "g")))]
  ""
  "*
{
...
(define_insn "*log_opqi3"
  [(set (match_operand:QI 0 "general_operand" "=g")
        (match_operator:QI 3 "c816_logical_operator"
            [(match_operand:QI 1 "general_operand" "%g")
             (match_operand:QI 2 "general_operand" "g")]))]
  ""
  "*
